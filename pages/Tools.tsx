        ...
        <div className="bg-background min-h-screen py-20">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                >
                    <div className="overflow-x-auto">
                        <table className="w-full text-left border-collapse">
                            <thead>
                                <tr className="bg-secondary/50 text-muted-foreground text-sm uppercase tracking-wider border-b border-border">
                            ...
                            <tbody className="divide-y divide-border text-muted-foreground">
                                {TOOLS_DATA.map((tool, idx) => (
                                    <tr key={idx} className={cn("hover:bg-muted/50 transition-colors", tool.recommended ? 'bg-primary/5' : '')}>
                                        <td className="p-6">
                                            <div className="flex flex-col">
                                                <span className="font-bold text-foreground text-lg flex items-center gap-2">
                                                    {tool.name}
                                                    {tool.recommended && (
                                                        <span className="px-2 py-0.5 rounded-full bg-primary text-primary-foreground text-[10px] uppercase font-bold">
                                                            Top Pick
                                                        </span>
                                                    )}
                                                </span>
                                        ...
                                        <td className="p-6">
                                            <span className="block text-foreground font-medium mb-1">{tool.aiFeatures}</span>
                                        </td>
                                        <td className="p-6">
                                            <span className={cn(
                                        ...
                                        <td className="p-6 font-mono text-foreground">{tool.price}</td>
                                        <td className="p-6 text-sm italic border-l border-border/50 bg-card/50">
                                            "{tool.verdict}"
                                        </td>
                                    </tr>
                                ))}
                ...
                <div className="mt-16 grid md:grid-cols-2 gap-8">
                    ...
                    >
                        <h3 className="text-xl font-bold text-foreground mb-4">Selection Criteria</h3>
                    ...
                    <motion.div
                        ...
                        whileInView={{ opacity: 1, x: 0 }}
                        viewport={{ once: true }}
                        className="bg-gradient-to-br from-secondary to-background p-8 rounded-2xl border border-border"
                    >
                        <h3 className="text-xl font-bold text-foreground mb-4">Need a Custom Recommendation?</h3>
                        ...
                        <a href="#/services" className="inline-flex items-center justify-center px-6 py-3 rounded-lg bg-primary text-primary-foreground font-semibold hover:bg-primary/90 transition-colors">
                            Book a Tool Audit
                        </a>
                    </motion.div>
                </div>
